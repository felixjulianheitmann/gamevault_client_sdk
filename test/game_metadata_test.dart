...
void main() {
  // final instance = GameMetadata();

  group('test GameMetadata', () {
    ...
    // List<PublisherMetadata> publishers (default value: const [])
    test('to test the property `publishers`', () async {
      // TODO
    });

    // developers of the game
    // List<DeveloperMetadata> developers (default value: const [])
    test('to test the property `developers`', () async {
      // TODO
    });

    // tags of the game
    // List<TagMetadata> tags (default value: const [])
    test('to test the property `tags`', () async {
      // TODO
    });

    // genres of the game
    // List<GenreMetadata> genres (default value: const [])

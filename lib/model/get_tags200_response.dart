...
class GetTags200Response {
  ...
  /// Returns a new [GetTags200Response] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static GetTags200Response? fromJson(dynamic value) {
    if (value is Map) {
      ...
      return GetTags200Response(
        ...
        data: TagMetadata.listFromJson(json[r'data']),
      );
    }
    return null;
  }
  ...
  static List<GetTags200Response> listFromJson(dynamic json, {bool growable = false,}) {
    ...
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = GetTags200Response.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, GetTags200Response> mapFromJson(dynamic json) {
    final map = <String, GetTags200Response>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = GetTags200Response.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }

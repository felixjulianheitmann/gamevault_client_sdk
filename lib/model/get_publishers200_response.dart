...
class GetPublishers200Response {
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is GetPublishers200Response &&
    other.meta == meta &&
    other.links == links &&
  ...
  @override
  String toString() => 'GetPublishers200Response[meta=$meta, links=$links, data=$data]';
    ...
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "GetPublishers200Response[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "GetPublishers200Response[$key]" has a null value in JSON.');
        });
        return true;
      }());
  ...
  static List<GetPublishers200Response> listFromJson(dynamic json, {bool growable = false,}) {
  ...
  static Map<String, List<GetPublishers200Response>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<GetPublishers200Response>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = GetPublishers200Response.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }

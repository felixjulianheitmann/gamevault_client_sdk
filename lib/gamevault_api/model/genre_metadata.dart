...
/// * [games] - games of the genre
/// * [updatedAt] - date the entity was updated
/// * [deletedAt] - date the entity was soft-deleted (null if not deleted)
@BuiltValue()
abstract class GenreMetadata
    implements Built<GenreMetadata, GenreMetadataBuilder> {
  ...
  factory GenreMetadata([void updates(GenreMetadataBuilder b)]) =
      _$GenreMetadata;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(GenreMetadataBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<GenreMetadata> get serializer =>
      _$GenreMetadataSerializer();
}

class _$GenreMetadataSerializer implements PrimitiveSerializer<GenreMetadata> {
  @override
  final Iterable<Type> types = const [GenreMetadata, _$GenreMetadata];

  @override
  final String wireName = r'GenreMetadata';

  Iterable<Object?> _serializeProperties(
    Serializers serializers,
    GenreMetadata object, {
  ...
  void _deserializeProperties(
    ...
    required GenreMetadataBuilder result,
  ...
  @override
  GenreMetadata deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = GenreMetadataBuilder();

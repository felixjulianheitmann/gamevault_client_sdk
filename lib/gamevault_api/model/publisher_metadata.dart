...
part 'publisher_metadata.g.dart';
...
/// * [games] - games published by the publisher
/// * [updatedAt] - date the entity was updated
/// * [deletedAt] - date the entity was soft-deleted (null if not deleted)
@BuiltValue()
abstract class PublisherMetadata
    implements Built<PublisherMetadata, PublisherMetadataBuilder> {
  ...
  factory PublisherMetadata([void updates(PublisherMetadataBuilder b)]) =
      _$PublisherMetadata;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(PublisherMetadataBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<PublisherMetadata> get serializer =>
      _$PublisherMetadataSerializer();
}

class _$PublisherMetadataSerializer
    implements PrimitiveSerializer<PublisherMetadata> {
  @override
  final Iterable<Type> types = const [PublisherMetadata, _$PublisherMetadata];

  @override
  final String wireName = r'PublisherMetadata';

  Iterable<Object?> _serializeProperties(
    Serializers serializers,
    PublisherMetadata object, {
  ...
  void _deserializeProperties(
    ...
    required PublisherMetadataBuilder result,
  ...
  @override
  PublisherMetadata deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = PublisherMetadataBuilder();

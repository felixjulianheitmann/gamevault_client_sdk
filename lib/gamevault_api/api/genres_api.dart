...
class GenresApi {
  ...
  ///
  /// Returns a [Future] containing a [Response] with a [GetGenres200Response] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<GetGenres200Response>> getGenres({
    num? page,
    num? limit,
    String? search,
    JsonObject? sortBy,
    ...
    GetGenres200Response? _responseData;
    ...
    try {
      ...
      _responseData = rawResponse == null
          ...
          : _serializers.deserialize(
              rawResponse,
              specifiedType: const FullType(GetGenres200Response),
    ...
    return Response<GetGenres200Response>(
      data: _responseData,

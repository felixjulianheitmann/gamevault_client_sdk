...
class AdminApi {
  ...
  ///
  /// Parameters:
  /// * [xDatabasePassword] - This header should include the database password. Without the correct password, your request will be denied.
  ...
  Future<Response<void>> getAdminDatabaseBackup({
    required String xDatabasePassword,
    ...
    final _path = r'/api/admin/database/backup';
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        r'X-Database-Password': xDatabasePassword,
        ...?headers,
      },
  ...
  /// Throws [DioException] if API call or serialization fails
  Future<Response<Health>> getAdminHealth({
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    final _path = r'/api/admin/health';
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
  ...
  /// Returns a [Future]
  /// Throws [DioException] if API call or serialization fails
  Future<Response<void>> postAdminDatabaseRestore({
    required String xDatabasePassword,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ...
    final _path = r'/api/admin/database/restore';
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        r'X-Database-Password': xDatabasePassword,
